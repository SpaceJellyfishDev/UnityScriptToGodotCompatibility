...
namespace UnityEngine
{
	...
	public struct Quaternion
	{
        ...
        public static implicit operator Godot.Quaternion(Quaternion gq)
        {
            return new Godot.Quaternion(gq.x, gq.y, gq.z,gq.w);
        }


        public static implicit operator Quaternion(Godot.Quaternion uq)
        {
