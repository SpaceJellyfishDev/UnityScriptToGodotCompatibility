...
namespace UnityEngine
{
	public partial class Texture2D : Texture
	{
		...
		public byte[] GetRawTextureData ()
		{
				...
				return _texture.GetImage().GetData();
		}
		...
		public void LoadRawTextureData (byte[] data)
		{
			Godot.Image image = new Godot.Image();
				//System.Drawing.Bitmap is not included in Godot 4
				//Bitmap bm;//Godot.Bitmap
				int width = 1920;
				int height = 1080;
			...
			try
			{
				...
				//image.CreateFromData(width, height, false, Godot.Image.Format.Rgba8, bytes);
				image = Godot.Image. CreateFromData(width, height, false, Godot.Image.Format.Rgba8, data);
