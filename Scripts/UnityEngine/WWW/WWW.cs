...
namespace UnityEngine
{
	public partial class WWW : CustomYieldInstruction, System.IDisposable
	{
		...
		void SendRequest(string requestData = "")
		{
			...
			{
				requestNode = new Godot.HttpRequest()
				{
					UseThreads = true
				};
				UnityEngineAutoLoad.Instance.AddChild(requestNode);
					 ...
					 requestNode.Connect("request_completed", Callable.From((int r, int rc, string[] h, byte[] b) => _on_request_completed(r, rc, h, b)));
			...
			string[] headers = new string[]
				...
				requestNode.Request(_url, headers, (HttpClient.Method)_method, requestData);
			}
		}
		...
		public static string EscapeURL(string s)
		{
				return //s.PercentEncode();
						 System.Uri.UnescapeDataString(s);
